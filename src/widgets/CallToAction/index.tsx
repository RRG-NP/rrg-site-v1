    ...
    <SectionOpacity classes="flex flex-col justify-center h-screen">
      ...
      <div className="mx-auto flex w-full max-w-[60vw] md:max-w-[90%] flex-1 flex-col items-center justify-center text-center px-4">
        ...
        <a 
          ...
          className="mt-[1.2vw] md:mt-5 inline-flex items-center gap-[0.5vw] md:gap-2 text-[1.5vw] md:text-[4vw] font-medium text-primary hover:text-primary/80 transition-colors duration-300"
        >
          <svg
            className="h-[1.5vw] w-[1.5vw] md:h-[4vw] md:w-[4vw]"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <Button
          ...
          classes="px-[1.8vw] md:px-8 py-[vw] w-[35vw] md:w-[80vw] min-h-[6vw] md:min-h-[14vw] text-[1.25vw] md:text-[3.5vw] bg-bg-1 hover:bg-bg-1/80"
          btnClasses="mt-[1.2vw] md:mt-6"
        />
      </div>

      <footer className="flex justify-between border-t border-t-gray-800 px-[5vw] md:px-6 py-[1.8vw] md:py-5 text-[1.6vw] md:text-[3.2vw] md:flex-col md:gap-4">
