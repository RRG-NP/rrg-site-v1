      ...
      >
        ...
        <div className='flex flex-col h-full justify-between'>
          ...
          <div className='flex flex-col gap-[0.8vw] w-full'>
            <div className='w-full border-b border-white/20 uppercase text-white/60 pb-[0.4vw] mb-[0.4vw]'>
              <h3 className='text-[0.9vw] md:text-[2vw] leading-[1.1]'>Connect</h3>
            </div>
            <Link
              target="_blank"
              rel="noreferrer"
            ...
            >
              <svg className='w-[1.2vw] h-[1.2vw]' viewBox="0 0 24 24" fill="currentColor">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
              <p className='text-[1vw] font-medium tracking-wide'>Facebook</p>
            </Link>
            <Link
              target="_blank"
              rel="noreferrer"
            ...
            >
              ...
              <p className='text-[1vw] font-medium tracking-wide'>LinkedIn</p>
            </Link>
            <Link
              target="_blank"
              rel="noreferrer"
            ...
            >
              ...
              <p className='text-[1vw] font-medium tracking-wide'>GitHub</p>
            </Link>
          </div>
        </div>
