      ...
      >
        ...
        <div className="flex flex-col justify-center gap-4 p-6 sm:p-8 lg:p-10">
          <div className="flex items-center gap-2">
            ...
            {post.category && <span className="text-xs font-medium uppercase tracking-wider text-text-1/50">{post.category}</span>}
          </div>
          ...
          <PostMeta date={post.date} readingTime={post.readingTime} author={post.author} />
