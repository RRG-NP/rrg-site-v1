...
const Index: FC<Props> = ({ label, classes }) => {
  return (
    <span
      className={cn(
        'inline-flex items-center rounded-full border border-stroke/60 bg-white/[0.04] px-[clamp(0.9rem,1.2vw,1.4rem)] py-[clamp(0.4rem,0.55vw,0.65rem)] backdrop-blur-md',
        classes,
      )}
    >
